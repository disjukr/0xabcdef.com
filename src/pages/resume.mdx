...
mainly implemented word document layouter and renderer from scratch.<br/>
maintained word document editor.

<p>
    <code class={styles.tag}>ie8</code>{' '}
    <code class={styles.tag}>contenteditable</code>{' '}
    <code class={styles.tag}>jsp</code>{' '}
    <code class={styles.tag}>flash</code>{' '}
    <code class={styles.tag}>jison</code>{' '}
    <code class={styles.tag}>jindojs</code>{' '}
    <code class={styles.tag}>jquery</code>{' '}
    <code class={styles.tag}>gulp</code>{' '}
    <code class={styles.tag}>browserify</code>{' '}
    <code class={styles.tag}>webpack</code>{' '}
    <code class={styles.tag}>electron</code>{' '}
    <code class={styles.tag}>babel</code>{' '}
    <code class={styles.tag}>react</code>{' '}
    <code class={styles.tag}>es2015</code>{' '}
    <code class={styles.tag}>html</code>{' '}
    <code class={styles.tag}>svg</code>{' '}
    <code class={styles.tag}>css</code>{' '}
</p>
...
<p>
    <code class={styles.tag}>ie8</code>{' '}
    <code class={styles.tag}>windows xp chrome</code>{' '}
    <code class={styles.tag}>ios safari</code>{' '}
    <code class={styles.tag}>jquery</code>{' '}
    <code class={styles.tag}>jinja</code>{' '}
    <code class={styles.tag}>python</code>{' '}
    <code class={styles.tag}>flask</code>{' '}
    <code class={styles.tag}>webpack</code>{' '}
    <code class={styles.tag}>babel</code>{' '}
    <code class={styles.tag}>react</code>{' '}
    <code class={styles.tag}>redux</code>{' '}
    <code class={styles.tag}>flow</code>{' '}
    <code class={styles.tag}>typescript</code>{' '}
    <code class={styles.tag}>next.js</code>{' '}
    <code class={styles.tag}>redis</code>{' '}
    <code class={styles.tag}>es2017</code>{' '}
    <code class={styles.tag}>html</code>{' '}
    <code class={styles.tag}>scss</code>{' '}
</p>
