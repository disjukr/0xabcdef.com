...
- github: <a href="https://github.com/disjukr">github.com/disjukr</a>
...
#### JS Bundlers [Webpack][webpack/enhanced-resolve], [FuseBox][fuse-box/fuse-box], [Parcel][parcel-bundler/parcel]
...
- ( webpack ) [normalize filenames to nfc when readdir](https://github.com/webpack/enhanced-resolve/pull/21)

- ( fuse-box ) [normalize filename](https://github.com/fuse-box/fuse-box/pull/344)

- ( parcel ) [Normalize filenames to nfc for hfs+](https://github.com/parcel-bundler/parcel/pull/322)
...
- adambard/learnxinyminutes-docs [[brainfuck/ko-kr][brainfuck/en] Add korean translation of brainfuck](https://github.com/adambard/learnxinyminutes-docs/pull/363)
